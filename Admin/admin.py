...
class AdminWindow(BoxLayout):
    ...
    def add_product_fields(self):
        ...
        crud_submit=Button(text='Add',size_hint_x=None,width=100,on_release=lambda x:self.add_product(crud_code.text,crud_name.text,crud_weight.text,crud_sold.text,crud_stock.text,crud_order.text,crud_purchase.text))
    ...
    def add_user(self, first,last,user,pwd,des):
        ...
        if first == '' or last==''or user=='' or pwd=='':
            ...
            self.user.insert_one({'first_name':first,'last_name':last,'user_name':user,'password':pwd,'designation':des,'date':datetime.now()})
            content = self.ids.scrn_contents
    ...
    def remove_user_fields(self):
        ...
        target.clear_widgets()
        crud_user = TextInput(hint_text='User Name')
        crud_submit = Button(text='Remove',size_hint_x=None,width=100,on_release=lambda x: self.delete_user(crud_user.text))
    ...
    def remove_product_fields(self):
        ...
        crud_submit = Button(text='Remove',size_hint_x=None,width=100,on_release=lambda x: self.delete_product(crud_code.text))
    ...
    def delete_user(self,user):
        ...
        if user=='':
            ...
            target_code=self.user.find_one({'user_name':user})
            if target_code==None:
                ...
                self.user.delete_one({'user_name':user})
    ...
    def change_screen(self, instance):
        ...
        elif instance.text == 'Manage User':
